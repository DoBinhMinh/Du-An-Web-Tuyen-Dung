          ...
          <div className="rounded-[8px] border border-[#DEDEDE] p-[20px]">
            ...
            <form action="" className="grid sm:grid-cols-2 grid-cols-1 gap-x-[20px] gap-y-[15px]">
              <div className="sm:col-span-2">
                <label htmlFor="campanyName" className="font-[500] text-[14px] text-black mb-[5px]">
                  Tên công ty *
                </label>
                <input
                  type="text"
              ...
              <div className="">
                <label htmlFor="workOT" className="font-[500] text-[14px] text-black mb-[5px]">
                  Làm việc ngoài giờ
                </label>
                <input
                  type="text"
              ...
              <div className="sm:col-span-2">
                <button className="px-[20px] h-[48px] bg-[#0088FF] rounded-[4px] font-[700] text-16[px] text-white cursor-pointer">
                  Cập nhật
                </button>
              </div>
            </form>
